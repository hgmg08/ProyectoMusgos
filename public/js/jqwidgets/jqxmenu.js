    ...
    a.extend(a.jqx._jqxMenu.prototype, {defineInstance: function() {
            ...
            a.jqx.utilities.resize(this.host, function() {
                if (b) {
                    ...
                    f.refreshTimer = setTimeout(function() {
                        f.refresh()
                    }, 1)
                }
            });
            if (b) {
                setInterval(function() {
                    var j = f.host.width();
                    var h = f.host.height();
                    if (f._lastWidth != j || f._lastHeight != h) {
                        f.refresh()
                    }
                    f._lastWidth = j;
                    f._lastHeight = h
            ...
            a.each(this.items, function() {
                var f = this;
                var e = a(f.element);
                b.removeHandler(e, "click");
                b.removeHandler(e, "selectstart");
                b.removeHandler(e, "mouseenter");
                b.removeHandler(e, "mouseleave");
                b.removeHandler(e, "mousedown");
                b.removeHandler(e, "mouseleave");
                var d = a(f.subMenuElement);
                var g = d.closest("div.jqx-menu-popup");
                g.remove()
            });
