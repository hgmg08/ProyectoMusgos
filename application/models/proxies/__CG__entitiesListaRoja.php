 ...
 */
class ListaRoja extends \entities\ListaRoja implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setCriterionIUCN($criterionIUCN);
    }

    public function getCriterionIUCN()
    {
        $this->__load();
        return parent::getCriterionIUCN();
    }
