 ...
 */
class Rank extends \models\Rank implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addRank($children);
    }
    ...
    {
        return array('__isInitialized__', 'name', 'id', 'taxon', 'children', 'parent');
    }
