 ...
 */
class Ecosistema extends \entities\Ecosistema implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addEcosistema($children);
    }
    ...
    {
        return array('__isInitialized__', 'name', 'id', 'children', 'parent', 'taxons');
    }
