...
class Estado extends \entities\Estado implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setFVCode($fVCode);
    }

    public function getFVCode()
    {
        $this->__load();
        return parent::getFVCode();
    }
    ...
    {
        $this->__load();
        return parent::addMunicipio($municipio);
    }
    ...
    {
        return array('__isInitialized__', 'name', 'FVCode', 'ISOCode', 'id', 'localidad', 'municipio');
    }
