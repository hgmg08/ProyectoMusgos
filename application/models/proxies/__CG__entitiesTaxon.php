...
class Taxon extends \entities\Taxon implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setSynonimClass($synonimClass);
    }

    public function getSynonimClass()
    {
        $this->__load();
        return parent::getSynonimClass();
    }
    ...
    {
        return array('__isInitialized__', 'name', 'acceptedName', 'endemic', 'authorInitials', 'synonimClass', 'creationDate', 'modificationDate', 'comments', 'modificationComments', 'status', 'id', 'children_rank', 'children_synonyms', 'rank', 'parent_rank', 'parent_synonyms', 'autores', 'publicaciones', 'sustratos');
    }
