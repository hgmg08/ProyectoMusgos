 ...
 */
class Autor extends \entities\Autor implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'name', 'creationDate', 'modificationDate', 'comments', 'id', 'taxones', 'publicaciones');
    }
